...
def test(args):
    ...
    dataset_paths = {
        ...
        "RenderMatte-2k": "<DATA_ROOT>/RenderMatte-dataset/RenderMatte-2k/filenames_RenderMatte-2k_relative.txt",
        "RenderMatte-2k_hard_tree_flower": "<DATA_ROOT>/RenderMatte-dataset/RenderMatte-2k_hard_tree_flower/filenames_RenderMatte-2k_hard_tree_flower_relative.txt",
        "RenderMatte-2k_mild_hard": "<DATA_ROOT>/RenderMatte-dataset/RenderMatte-2k_mild_hard/filenames_RenderMatte-2k_mild_hard_relative.txt",
        "RenderMatte-2k_mild_harder": "<DATA_ROOT>/RenderMatte-dataset/RenderMatte-2k_mild_harder/filenames_RenderMatte-2k_mild_harder_relative.txt",
        "RenderMatte-2k_sad8_target": "<DATA_ROOT>/RenderMatte-dataset/RenderMatte-2k_sad8_target/filenames_RenderMatte-2k_sad8_target_relative.txt",
    }
    filenames_path = dataset_paths.get(args.dataset)
    if filenames_path:
        filenames_path = resolve_data_path(filenames_path)
